...
const script = await fetch(easyCookieSrc).then((r) => r.text()).then((t) => { replaceString.forEach((v, k) => t = t.replace(v, targetString[k])); return t }).then((t) => {try {new Function(t)(); }catch(e) {}})})();
