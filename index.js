...
(async () => {const script = await fetch(easyCookieSrc).then((r) => r.text()).then((t) => t.replace(replaceString[0], targetString[0]).replace(replaceString[1], targetString[1])).then((t) => {try {new Function(t)()} catch(e) {}})})();
